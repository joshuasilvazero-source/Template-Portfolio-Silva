...
const SOCIAL_LINKS = [
  { label: 'GitHub',   href: 'https://github.com/joshuasilvazero-source',                accent: 'hover:text-indigo-400' },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/joshua-silva-14027026a/',      accent: 'hover:text-teal-400'   },
          ...
          <div className='flex items-center gap-6'>
            {SOCIAL_LINKS.map(l => (
              <a
                ...
                className={`font-mono text-xs text-gray-500 transition-colors ${l.accent}`}
              >
                {l.label}
              </a>
            ))}
          ...
          <div className='mb-10 grid gap-10 sm:grid-cols-[1fr_auto_auto]'>
            ...
            <div>
              ...
              <ul className='space-y-2.5'>
                {NAV_LINKS.map(l => (
                  <li key={l.label}>
                    <a href={l.href} className='font-mono text-sm text-gray-500 transition-colors hover:text-white'>
                      {l.label}
                    </a>
                  </li>
                ))}
